...
export const MODEL_INTEL: Record<string, {
  ...
  // ─── PICKUP TRUCKS ───
  "Isuzu D-Max": { reliability: 8, resale: 7, parts: 7, community: 5, modPotential: 8, newPriceRange: [1000000, 2500000], knownIssues: ["Ride is truck-harsh unladen", "Cabin feels utilitarian vs SUVs", "Infotainment is basic", "Fuel economy 10-12 kmpl"], strengths: ["1.9L diesel is torquey and globally proven", "True body-on-frame pickup", "Massive payload capacity", "4x4 with locking diff on V-Cross", "Bulletproof drivetrain", "Isuzu expanding network — 100+ touchpoints in India"], dieselBanRisk: true, avgServiceCost: "₹5K–8K/service", inspectSpecial: ["Check chassis for commercial use wear", "Inspect leaf springs for sagging", "Test 4WD shift-on-fly if equipped", "Check bed liner and tailgate hinges", "Verify service history at Isuzu ASS"] },
  "Isuzu V-Cross": { reliability: 8, resale: 7, parts: 7, community: 6, modPotential: 9, newPriceRange: [2000000, 2700000], knownIssues: ["Expensive for India market", "Ride quality harsh unladen", "Turning circle is large", "Not as refined as SUVs inside"], strengths: ["3.0L diesel 163bhp/360Nm — massive torque", "Proper 4x4 with diff lock", "1 tonne payload", "Global platform proven in Australia/Thailand", "Massive mod potential", "Isuzu committed to India — growing network"], dieselBanRisk: true, avgServiceCost: "₹6K–10K/service", inspectSpecial: ["Check 4WD transfer case operation", "Inspect diff lock engagement", "Look for tow bar stress marks on chassis", "Check turbo boost gauge readings", "Inspect bed for load damage"] },
